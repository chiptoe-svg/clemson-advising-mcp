...
| **GC**           | Graphic Communications, the Clemson department this began with. It survives in the `core/` Python package name and the departmental layer's id (`departments/gc/`); the tool names dropped the prefix on 2026-08-31. The catalog now covers seven College of Business programs plus minors and certificates. |
