...
const EXPECTED: Record<number, string> = {
  1: "202601", 2: "202601", 3: "202601", 4: "202601",
  5: "202608", 6: "202608", 7: "202608", 8: "202608", 9: "202608", 10: "202608", 11: "202608",
  12: "202701",
};
...
test("defaultTerm by month (2026), through the test clock seam", () => {
  try {
    for (let m = 1; m <= 12; m++) {
      ...
      const code = "term" in r ? r.term : (r.error.match(/\b20\d{4}\b/)?.[0] ?? term);
